...
#D =/opt/software/numerics/deal.II-7.1
#IGAInclude=/home/rudraa/workspace/IGA/base
#hdfLibrary=/opt/software/numerics/hdf5-1.8.9/install/lib/libhdf5_cpp.so.7.0.3
#hdfInclude=/opt/software/numerics/hdf5-1.8.9/install/include
SUPERLU_INC=/opt/software/numerics/SuperLU_4.3/SRC/
SUPERLU_LIB= /opt/software/numerics/SuperLU_4.3/lib/libsuperlu_4.3.a
#SUPERLU_INC=/opt/software/numerics/SuperLU_MT_2.1/SRC/
#SUPERLU_LIB= /opt/software/numerics/SuperLU_MT_2.1/lib/libsuperlu_mt_PTHREAD.a
D=/Library/deal.II-bundle/deal.II-8.0.0/
IGAInclude=/opt/software/numerics/igaBase                                                                                                                                                      
#IGAInclude=/Users/rudraa/Documents/workspace/projects/igaBase
 
hdfInclude=/opt/software/numerics/hdf5-1.8.12/install/include
hdfLibrary=/opt/software/numerics/hdf5-1.8.12/install/lib/libhdf5.dylib
#SUPERLU_INC=/opt/software/numerics/SuperLU_4.3/SRC/                      
#SUPERLU_LIB= /opt/software/numerics/SuperLU_4.3/lib/libsuperlu_4.3.a
...
#CXX= /opt/software/numerics/hdf5-1.8.9/install/bin/h5c++
CXX=/opt/software/numerics/hdf5-1.8.12/install/bin/h5c++
...
libs.g   := $(lib-deal2.g) $(hdfLibrary) $(SUPERLU_LIB)
libs.o   := $(lib-deal2.o) $(hdfLibrary) $(SUPERLU_LIB)
...
./%.g.$(OBJEXT) :
	@echo "==============debug========= $(<F)  ->  $@"
	@$(CXX) $(CXXFLAGS.g) -I$(IGAInclude) -I$(hdfInclude) -I$(SUPERLU_INC) -c $< -o $@
./%.$(OBJEXT) :
	@echo "==============optimized===== $(<F)  ->  $@"
	@$(CXX) $(CXXFLAGS.o) -I$(IGAInclude) -I$(hdfInclude) -I$(SUPERLU_INC) -c $< -o $@
